"""
Hippocampal Consolidation v18: Pure Hebbian CA1
=================================================

CA1 uses pure Hebbian association, not error-driven learning:
  W_sc += lr * outer(stellate, ca3)

Stellate is directly imposed as the postsynaptic activity.
CA3 is the presynaptic input. The outer product is ~0.2% nonzero
(4% stellate * 5% CA3), so each episode writes to a tiny,
pattern-specific subset of the weight matrix.

During retrieval: W_sc @ ca3 reactivates the associated stellate
neurons. k-WTA enforces sparsity. Weight decay provides forgetting.

No error computation anywhere in CA1.
"""
...
ca1_params = {
    "lr": 10.0, "weight_decay": 1.0, "k_active": 50,
}
...
print("=" * 70)
print("HIPPOCAMPAL v18: PURE HEBBIAN CA1, FiLM GATING")
print("=" * 70)
...
with open("consolidation_v18_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("  Saved to consolidation_v18_results.json")
...
fig.suptitle("Hippocampal v18: Pure Hebbian CA1, FiLM Gating",
...
plt.tight_layout()
plt.savefig("consolidation_v18_results.png", dpi=150, bbox_inches='tight')
print("  Saved plot")
