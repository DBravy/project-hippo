"""
Hippocampal Consolidation v20: No Connectivity Masks
=====================================================

CA1 and Sub use pure Hebbian with no connectivity masks.
Sparse outer products (0.2% CA1, 2.5% Sub) provide natural sparsity
in weight updates. Full 1M synapse capacity per stage.

  CA1: W_sc += lr * outer(stellate, ca3), k-WTA(50)
  Sub: W_ca1 += lr * outer(pyramidal, ca1), k-WTA(500)
...
print("=" * 70)
print("HIPPOCAMPAL v20: NO CONNECTIVITY MASKS, FiLM GATING")
print("=" * 70)
...
with open("consolidation_v20_results.json", "w") as f:
    json.dump(results, f, indent=2)
print("  Saved to consolidation_v20_results.json")
...
fig.suptitle("Hippocampal v20: No Connectivity Masks, FiLM Gating",
...
plt.tight_layout()
plt.savefig("consolidation_v20_results.png", dpi=150, bbox_inches='tight')
print("  Saved plot")
